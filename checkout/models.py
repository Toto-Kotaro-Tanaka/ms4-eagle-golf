...
class Order(models.Model):
    ...
    stripe_pid = models.CharField(max_length=100, null=False,
                                  blank=False, default='')
...
class OrderLineItem(models.Model):
    ...
    product_club = models.CharField(max_length=5,
                                    null=True,
                                    blank=True)  # R, L for Golf Clubs
    ...
    def __str__(self):
        return f'Product ID: {self.product.sku} \
